...
Built as a front-end portfolio project, Cube Atlas combines a manipulable 3D cube, step-by-step move animations, visual turn diagrams, and plain-language positioning guidance. It is designed to make the logic behind each stage easier to follow—not just present a long list of notation.
...
- Shows face-coloured diagrams, arrow directions, conventional cube notation, and the active move alongside the live cube.
...
1. **The Daisy** — place four white edge pieces around the yellow top centre.
...
7. **Position Yellow Corners** — match the completed yellow corners to their side centres.
...
The cube begins with a fixed solved colour layout—white opposite yellow, red opposite orange, and blue opposite green. Every state is balanced so that there are nine stickers of each colour.
